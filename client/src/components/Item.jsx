...
export default function Item(props) {
    ...
    return (
        <div className={`${props.selectedItem !== null && !isClosing ? "opacity-100" : "opacity-0 pointer-events-none"} flex items-center absolute top-1/2 -translate-y-1/2 h-full transition-opacity duration-400 z-50`}>
                    ...
                    <div className="grid content-between gap-2 p-4">
                        <div className="grid gap-2">
                            <div className="flex justify-between items-start gap-6">
                                <h1 className="uppercase font-medium text-2xl">{props.selectedItem?.name}</h1>
