        ...
        <section className="flex mt-24 pt-16 w-[80%]">
            <article className="flex flex-col gap-4 w-full relative">
                <div className="grid gap-2">
                    ...
                    <h2 className="text-silver/70 text-lg"> Order for delivery or reserve a table!</h2>
                    <div className="flex gap-4 py-5">
                        <a href="#reservation" className="group flex justify-between items-center gap-6 rounded-sm px-6 py-4 font-medium tracking-wider transition-all duration-200 hover:brightness-120 bg-pine-teal/50 text-silver"><ChevronDown className="transition-transform duration-500 group-hover:rotate-360" />RESERVE A TABLE</a>
                        <button onClick={() => navigate("/menu")} className="group flex justify-between items-center gap-6 rounded-sm px-6 py-4 font-medium tracking-wider transition-all duration-200 hover:brightness-120 border-b border-metallic-gold bg-metallic-gold/20 text-metallic-gold">EXPLORE OUR MENU<ChevronRight className="text-metallic-gold transition-transform duration-500 group-hover:rotate-360" /></button>
                    </div>
                </div>
