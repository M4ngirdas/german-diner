                        ...
                        <div className="grid gap-4">
                            <div className="grid gap-2 transition-colors duration-200 focus-within:text-metallic-gold">
                                ...
                                <input
                                    ...
                                    className="peer px-2 py-4 rounded-sm placeholder:text-silver/50 focus:outline-metallic-gold outline outline-silver/50"
                                />
                            </div>
                            <div className="grid gap-2 transition-colors duration-200 focus-within:text-metallic-gold">
                                ...
                                <input
                                    ...
                                    className="px-2 py-4 rounded-sm placeholder:text-silver/50 focus:outline-metallic-gold outline outline-silver/50"
                                />
                            </div>
                        </div>
