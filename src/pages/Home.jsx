                        ...
                        <aside className="flex flex-col gap-2 h-85">
                            ...
                            <div className="w-50">
                                <img
                                    ...
                                    className={`${specialDeals.weekendSpecial ? "block" : "hidden"} rounded-sm object-contain border`}
                                />
                                <img
                                    src={pretzelDeal}
                                    alt="Pretzel deal poster"
                                    className={`${specialDeals.pretzelDeal ? "block" : "hidden"} rounded-sm object-contain border`}
                                />
                                <img
                                    src={coffeeDeal}
                                    alt="Coffee deal poster"
                                    className={`${specialDeals.coffeeDeal ? "block" : "hidden"} rounded-sm object-contain border`}
                                />
                            </div>
